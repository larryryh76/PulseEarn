      ...
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12 md:mb-20 px-4">
            ...
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-6 text-text-primary tracking-tight">Got <span className="text-text-tertiary opacity-40 dark:opacity-100">Questions?</span></h2>
