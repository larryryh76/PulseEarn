      ...
      <div className="max-w-5xl mx-auto space-y-12 pb-24 animate-in">
        ...
        <section className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/[0.05] pb-10">
           <div className="space-y-1">
              <h2 className="section-label">Referral Program</h2>
              <h1 className="text-4xl font-bold tracking-tight text-glow">Invite Friends</h1>
              <p className="text-sm text-white/40 font-medium max-w-md pr-12">
                 Share PulseEarn with your network and earn rewards for every successful referral.
              </p>
           </div>
           ...
           <div className="flex items-center gap-4">
              <div className="px-5 py-3 glass-panel rounded-2xl flex items-center gap-3">
                 ...
                 <span className="text-[10px] font-bold uppercase tracking-widest">Growth Tier: Basic</span>
              </div>
           </div>
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
           ...
           <div className="lg:col-span-8 space-y-10">
              ...
              <div className="glass-panel p-10 rounded-[3rem] border-white/10 relative overflow-hidden group shadow-2xl">
                 ...
                 <div className="relative z-10 space-y-8">
                    <div className="flex items-center gap-3">
                       ...
                       <h3 className="text-xl font-bold tracking-tight">Your Referral Code</h3>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-stretch gap-4">
                       <div className="flex-1 bg-black/40 border border-white/5 rounded-[2rem] px-8 py-6 flex items-center justify-between group/code hover:border-primary/30 transition-colors">
                          <div>
                             <p className="text-[9px] font-bold uppercase tracking-widest text-white/20 mb-1">Referral ID</p>
                    ...
                    <p className="text-xs text-white/30 font-medium leading-relaxed max-w-xl">
                       Share your referral code with friends. You both will receive bonus points once they sign up and complete their first few tasks.
                    </p>
                 </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                 {[
                   { label: 'Total Referrals', val: userData.stats?.referralsCount || 0, icon: Users, color: 'primary' },
                   { label: 'Pending Rewards', val: '0 PTS', icon: Zap, color: 'primary' },
                   { label: 'Conversion Rate', val: '0.0%', icon: TrendingUp, color: 'emerald-500' },
                 ].map((stat, i) => (
              ...
              <div className="space-y-6 pt-6">
                 ...
                 <div className="p-16 text-center glass-panel rounded-[3rem] border-white/5 border-dashed">
                    ...
                    <h4 className="text-lg font-bold opacity-30">No Referrals Yet</h4>
                    <p className="text-sm opacity-10 mt-2">Share your code to start growing your rewards.</p>
                 </div>
              </div>
           </div>
           ...
           <div className="lg:col-span-4 space-y-10">
              ...
              <div className="glass-panel p-8 rounded-[2.5rem] space-y-8">
                 ...
                 <div className="space-y-6">
                    {[
                      { step: '01', title: 'Share Code', desc: 'Invite friends to join PulseEarn using your unique link.' },
                      { step: '02', title: 'Friend Joins', desc: 'Your friend signs up and verifies their account.' },
                      { step: '03', title: 'Get Rewarded', desc: 'Earn bonus points after your friend completes their first 5 tasks.' }
                    ].map((step, i) => (
              ...
              <div className="glass-panel p-8 rounded-[2.5rem] space-y-6 bg-emerald-500/[0.01] border-emerald-500/10">
                 <h4 className="text-base font-bold text-emerald-500/80">Growth Bonus</h4>
                 <div className="space-y-4">
                    <div className="p-5 bg-white/5 rounded-3xl border border-white/5 space-y-3">
                       <p className="text-xs font-medium text-white/50 leading-relaxed">
                          Invite 10+ friends to unlock the <span className="text-emerald-400 font-bold">Elite Tier</span>: +25% bonus on all referral earnings.
                       </p>
