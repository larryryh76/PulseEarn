...
const steps = [
  ['01', 'Create your account', 'Create your independent PSEmine account and reserve your place in the campaign.'],
...
const faqs = [
  ['What is PSEmine?', 'PSEmine is an independent digital mining campaign with its own account experience and campaign rules. You join, activate mining tools and follow your campaign earnings.'],
...
export const PSEMineLanding: React.FC = () => {
  ...
  return (
    ...
    <main className="psemine-page">
      <section className="psemine-hero psemine-shell"><div className="psemine-hero-copy"><p className="psemine-eyebrow"><CircleDot size={13} /> An independent PSEmine campaign</p><h1>Mine SHA.<br /><em>Build your earning capacity.</em></h1><p className="psemine-lede">Join PSEmine, activate mining tools and follow your campaign earnings in pounds.</p><div className="psemine-hero-actions"><a className="psemine-button" href="/mine/signup">Join PSEmine <ArrowRight size={17} /></a><a className="psemine-text-link" href="#how-it-works">How it works <ArrowDownRight size={16} /></a></div><p className="psemine-note">A clearer way to enter digital mining.</p></div><ProductVisual /></section>
      ...
      <section className="psemine-final-cta psemine-shell"><ShaMark large /><p className="psemine-eyebrow">The next campaign is taking shape</p><h2>Build your place<br /><em>inside PSEmine.</em></h2><p>Create a dedicated PSEmine account and be ready for a different kind of mining experience.</p><a className="psemine-button" href="/mine/signup">Join PSEmine <ArrowRight size={17} /></a></section>
    </main>
    </PSEMineLandingLayout>
  )
}
