...
import { Activity, ArrowRight, ShieldAlert, WalletCards } from 'lucide-react'
...
interface Snapshot {
  ...
  earnings?: { grossToolEarningsGBP?: string; referralBonusGBP?: string; status?: string }
...
export const PSEmineApp: React.FC = () => {
  ...
  const total = Number(snapshot?.earnings?.grossToolEarningsGBP || 0) + Number(snapshot?.earnings?.referralBonusGBP || 0)
