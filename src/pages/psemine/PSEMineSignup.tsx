...
import { Mail, Lock, User as UserIcon, ArrowRight, Eye, EyeOff, Loader2 } from 'lucide-react';
          ...
          >
            <div style={{ textAlign: 'center', marginBottom: '28px' }}>
              ...
              <p style={{ color: 'var(--pm-muted)', fontSize: '13px', margin: 0 }}>
                Create your independent digital mining account
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <UserIcon size={16} style={{ position: 'absolute', left: '14px', top: '50%', transform: 'translateY(-50%)', color: '#707786' }} />
                  <input
                    type="text"
                    placeholder="MinerAlias"
                    value={username}
            ...
            <div style={{ marginTop: '24px', paddingTop: '20px', borderTop: '1px solid var(--pm-line)', textAlign: 'center' }}>
              <p style={{ fontSize: '13px', color: 'var(--pm-muted)', margin: 0 }}>
                ...
                <Link to="/mine/login" style={{ color: 'var(--pm-cyan)', textDecoration: 'none', fontWeight: 700 }}>
                  Sign In
                </Link>
              </p>
            </div>
