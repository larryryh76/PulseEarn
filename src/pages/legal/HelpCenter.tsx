...
const HelpCenter: React.FC = () => {
  return (
    <DocLayout title="Help Center" lastUpdated="June 20, 2026">
      <section>
        ...
        <ul>
          ...
          <li><strong>Earn Points & XP:</strong> Accumulate points for value and XP for platform seniority.</li>
      ...
      <section>
        ...
        <p>1,000 Points equals $1.00 USD in our standard reward economy.</p>
      ...
      <section>
        ...
        <ul>
          <li><strong>Missing Points:</strong> Ensure you completed all task requirements and wait at least 48 hours for manual reviews.</li>
