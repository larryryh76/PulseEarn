    ...
    <section className="py-20 md:py-32 relative overflow-hidden bg-[#050507]">
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="relative bg-background border border-border-bright rounded-3xl md:rounded-[3rem] p-10 md:p-24 flex flex-col items-center text-center overflow-hidden">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-6 max-w-2xl tracking-tight text-text-primary leading-tight">
              Ready to Start <br className="hidden sm:block" />
              <span className="text-text-tertiary">Earning?</span>
            </h2>
